<?php
    ...
    if (isset($_POST['admin_form'])) {
        ...
        $targetMovie = "../media/movie/" . basename($_FILES['movie_file']['name']);
        ...
        $movie_file_path = "media/movie/" . basename($_FILES['movie_file']['name']);

        $sql = "INSERT INTO movie(movie_name, movie_genre, movie_cover_path, movie_file_path) VALUES('$movie_name', '$movie_genre', '$movie_cover_path', '$movie_file_path')";
