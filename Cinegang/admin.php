<?php
    session_start();
    // Only Allow Admin
    if (!(isset($_SESSION['loggedinCineGang']) && $_SESSION['loggedinCinegang'] == true && $_SESSION['uid'] == 1)) {
...
<body>
    ...
    <footer>
        ...
        <h3>&copy; Made by <a href="https://www.facebook.com/Jaysooony" target="_blank">Jayson Yap</a>, <a href="https://www.facebook.com/carljustin808" target="_blank">Carl Cueto</a>, and <a href="https://www.facebook.com/justine1251" target="_blank">Justine Morales</a></h3>
    </footer>
    <!-- Footer End -->
    <!-- JS Scripts -->
